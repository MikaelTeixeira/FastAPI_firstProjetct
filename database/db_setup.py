...
def verify_table_exist(name: str) -> str | None:
    ...
    Retorna o nome da tabela se existir, None se não existir.
    """
...
def create_table(name: str):
    """
    Cria a tabela especificada se não existir.
    ...
    try:
        ...
        print(f"Erro: tabela {name} não está registrada nos models!")
        return
